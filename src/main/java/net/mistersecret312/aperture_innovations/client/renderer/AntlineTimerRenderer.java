...
public class AntlineTimerRenderer implements BlockEntityRenderer<AntlineTimerBlockEntity>
{
						   ...
						   MultiBufferSource bufferSource, int packedLight, int packedOverlay)
	{
		...
		ResourceLocation activityTexture = new ResourceLocation(ApertureInnovations.MODID,
				"textures/antline/timer/timer_" + segment + ".png");
		if(color == -1)
		{
			backTexture = new ResourceLocation(ApertureInnovations.MODID,
		...
		if(segment < 8)
		{
			ResourceLocation activityTextureNext = new ResourceLocation(ApertureInnovations.MODID,
